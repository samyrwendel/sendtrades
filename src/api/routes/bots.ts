...
const listBots = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
// Obter bot por ID
const getBot = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { user } = req as AuthenticatedRequest;
...
// Atualizar bot
const updateBot = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { user } = req as AuthenticatedRequest;
...
// Excluir bot
const deleteBot = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { user } = req as AuthenticatedRequest;
...
async function validateExchangeCredentials(exchange: string, credentials: { apiKey: string; secretKey: string }): Promise<boolean> {
  try {
...
router.post('/:id/toggle', authMiddleware, async (req: Request, res: Response): Promise<void> => {
  try {
    const { user } = req as AuthenticatedRequest;
