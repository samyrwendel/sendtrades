...
const listLogs = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
const clearLogs = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { user } = req as AuthenticatedRequest;
    const { botId } = req.params;
...
const createLog = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { user } = req as AuthenticatedRequest;
    const { botId } = req.params;
