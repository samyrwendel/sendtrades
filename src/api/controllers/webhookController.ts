...
export class WebhookController {
  static async handleSignal(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Log do cálculo
      const calculationLog: BotLogEntry = {
        id: uuidv4(),
        botId: bot.id,
        public_id: signal.public_id,
      ...
      const systemErrorLog: BotLogEntry = {
        id: uuidv4(),
...
async function saveLog(log: BotLogEntry) {
  try {
